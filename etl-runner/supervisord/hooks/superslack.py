...
class SuperSlacker(ProcessStateMonitor):
    ...
    def _get_opt_parser(cls):
        ...
        parser.add_option(
            "-t",
            "--token",
            default=os.getenv("BLOCKCHAIN_ETL_SLACK_TOKEN"),
            help="Slack Token",
        )
        parser.add_option(
            "-c",
            "--channel",
            default=os.getenv("BLOCKCHAIN_ETL_SLACK_CHANNEL"),
            help="Slack Channel",
        )
        parser.add_option(
            "-w",
            "--webhook",
            default=os.getenv("BLOCKCHAIN_ETL_SLACK_WEBHOOK"),
        ...
        parser.add_option(
            "-u", "--username", default="superslacker", help="Slack username"
        )
        parser.add_option(
            "-n",
            "--hostname",
