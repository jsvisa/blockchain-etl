...
TRACKS = Table(
    ...
    Column("blknum", BigInteger),
    Column("txhash", String, primary_key=True),
    Column("logpos", BigInteger, primary_key=True, nullable=True),
    Column("trace_address", Text, primary_key=True, nullable=True),
    Column("original", String),
    Column("label", String),
    Column("hop", Integer, default=0),
    Column("in_value", Numeric, default=0),
    Column("out_value", Numeric, default=0),
    Column("token_address", String),
    Column("token_name", String),
